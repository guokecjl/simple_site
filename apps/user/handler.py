...
from config import GT_ID, GT_KEY, EID, PRIVATE_KEY, SCENE_ID, EXPIRES_IN
...
class GetQrCodeHandler(BaseRequestHandler):
    ...
    def get(self):
        ...
        try:
            eg.decode_verified_identity(data, b'Gm4TrMQT8k+MzwdsGYAgS8sH2rwihxca5fYuO/JrMKCCrnmqCYN3CfTcmIgq09rygWKg8hutApfWaOUefzpQVg==', b'-----BEGIN RSA PUBLIC KEY-----\nMEgCQQDNqn3'
                                                b'ah/XAtHF288A0xby9UMyTD29zT0zzBydPY8uLfJSNDIpkfPADJ+le\nYyrfVm8tHvRmj+52CDox8J1+6csRAgMBAAE=\n-----END RSA PUBLIC KEY-----\n')
        except:
            pass
